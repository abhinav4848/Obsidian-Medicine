...
- sore throat
- lymphadenopathy
- malaise, myalgia, arthralgia, headache, night sweats
- diarrhoea
- **maculopapular rash** (widespread, symmetrical) #rash
- mouth ulcers
- rarely meningoencephalitis

# Definition of terms
From [NICE CKS](https://www.nice.org.uk/guidance/qs157/chapter/Quality-statement-3-HIV-indicator-conditions#definitions-of-terms-used-in-this-quality-statement-3) #notAKT 
...
[BHIVA guidelines](https://bhiva.org/wp-content/uploads/2024/10/HIV-testing-guidelines-2020.pdf) 
- The **"window period"** is the time between getting infected and when a test can **reliably detect that infection**.
- **"Fourth-generation serology"** refers to modern HIV blood tests that detect:
    - HIV p24 antigen (appears early)
    - HIV antibodies (appear later)
- Guidelines have updated the maximum window period to 45 days (≈ 6 weeks)
- After 45 days from exposure, a negative 4th-gen HIV test is considered conclusive (in most guidelines, e.g. UK/BHIVA)
