...
urls:
  - "[YouTube- Health Economic Evaluation Basics - Putting a price tag on health](https://www.youtube.com/watch?v=cUgkWYeRsJk)"
---
...
## Cost-minimisation analysis (CMA)
The final outcome of competing interventions is same.
Only inputs, i.e. costs are taken into consideration. 
...
- Indirect - those incurred by the reduced productivity of the patient (e.g. time off work, reduced work productivity, time spent caring for the patient by relatives)
- Intangible - those that are difficult to measure (e.g. pain or suffering on the part of the patient)

Opportunity cost: if you spend all the money on few health programs, you don't have money left to spend it on others. So that's lost opportunity. 