...
##### Treatment
- Fluid restriction (500-1000mL/day) > Demeclocycline/Tolvaptan
...
- Tolvaptan (ADH antagonist) is used for resistant hyponatremia in acute cases. Even more rarely used. Vaptans antagonise V2 receptors and cause selective water diuresis, sparing the electrolytes. So, avoid in hypovolemic picture. This stimulates thirst receptors causing the desire to drink free water. They are however, hepatotoxic to patients with underlying liver disease. 
...
#mnemonic "From low to high, your pons will die. From high to low, your brains will blow."

#### Osmotic demyelination syndrome (central pontine myelinolysis)  
- can occur due to over-correction of severe hyponatremia
- pathophysiology:
    - thought to develop secondary to astrocyte (and possibly oligodendrocyte) apoptosis. Astrocytes and oligodendrocytes (cells of the glial syncytium) are crucial for normal myelination
    - When there is **_acute_** hyponatremia (low osmolality outside cells), brain cells can get inflow of water and swell and get injured (edema, herniation, etc). To be protected from this, in **_chronic_** hyponatremia, brain cells loose osmotically active substances (themselves get hypotonic, so they don't get water inflow inside and don't swell). So chronic hyponatremic patients are mostly asymptomatic.
    - Now, if overenthusiastic human comes into the picture who just treats the laboratory reports, sees the low serum sodium and tries to correct it **_TOO FAST_** with 3% NaCl, those cells can't generate osmolytes that easily and fast. Result? relatively high osmolality outside due to rapidly corrected hyponatremia and low osmolality inside the brain cells. So water comes out, cells shrink, may die also → demyelination
