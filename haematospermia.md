...
tags:
  - urology
---
**Information and Guidance for Primary Care**
# Introduction
- Haematospermia is the visible presence of blood in the semen.
- The blood appears red when bleeding is recent and red/brown when old.
- It is usually temporary and almost always benign.
# Association with Malignancy
There is no clear link between haematospermia and [[cancer- prostate|Prostate Cancer]] in men with:
- A normal digital rectal examination (DRE)
- A normal [[prostate|PSA test]]
# Common Causes
### Inflammatory conditions (including STIs)
- Vesiculitis
- Prostatitis
- Urethritis
- Epididymitis
...
- Check blood pressure (to exclude malignant hypertension)
- Perform urinalysis 
...
- If examination and investigations are normal:
    ...
    - This applies irrespective of age and number of episodes
...
2. NICE Clinical Knowledge Summaries; _Haematospermia_ (2016)
