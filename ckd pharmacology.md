...
- ACR >= 3
	- Offer [[ace inhibitors|ACE]] or ARB to max tolerated dose
		- creatinine increase on ACE is acceptable up to 20% from baseline in CKD. 
	- Offer [[diabetes drugs#Glucose excretion|SGLT2 inhibitor]] if T2DM & ACR >=30 & criteria in license met
		- Consider SGLT2 inhibitor if all the above, but ACR is still b/w 3 & 30. 
...
| [[Nitrofurantoin]] | avoided in CKD >= 3 (eGFR 45) cuz risk of side effect and treatment failure.                                                                                                                                                                                                                                                                                                                                                                                                                                   |
