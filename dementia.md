...
- **Score 5-8**: Requires further information through the informant questionnaire.

Informant interview:
- Has 6 yes-no-N/A questions
- If patient scores 0-3, cognitive impairment is indicated

Do Bloods and refer to memory clinic aka **Suspected dementia pathway** 
...
| ----------------------------------------------------------------- | ------------------------------------------------------ |
| Progressive onset                                                 | Rapid Onset                                            |
| Long Term Symptomatology                                          | Short term Symptomatology                              |
| Mood Variations                                                   | Constantly depressed mood                              |
| The patient tries to answer to questions                          | Short answers like "I don't  know", negativism         |
| Patient is concealing amnesia                                     | Highlights amnesia                                     |
| Constant cognitive decline                                        | Fluctuating Cognitive impairment                       |
| Have no insight into their illness. Brought to Hospital by others | Aware of their illness. Come to hospital on their own. |

# Alzheimer's
Alzheimer's disease dementia classically presents as slowly worsening memory loss and forgetfulness that progresses to affect speech, orientation, and concentration.

3A for Alzheimer's (mnemonic):
- Apraxia- can't move (no useful actions)
- Aphasia- can't speak
...
# Others
[[frontotemporal dementia|Fronto-temporal dementia]] (Pick's Disease)
**Normal pressure hydrocephalus**
- Hakim's #triad: Wet, wacky, wobbly grandpa.
