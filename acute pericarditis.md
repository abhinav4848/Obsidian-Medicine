...
- Constrictive, because thickened pericardium prevents diastolic filling of ventricles. 
lasts for less than 4-6 weeks. 
# Aetiology
- viral infections (Coxsackie) in developed world
...
- trauma
# Features
- Pleuritic (retrosternal) chest pain, worsens on inspiration, lying flat & relieved by sitting forwards (reduces contact with inflamed pericardium). Patient may have recent cough, or viral illness history.
- Pericardial friction rub on stethoscope- Best heard when patient is sitting up + leaning forward, and expiring.
- other symptoms include a non-productive cough, dyspnoea and flu-like symptoms. 
# Investigations
- all patients with suspected acute pericarditis should have TTE (echo). 
- bloods
    - inflammatory markers
    - troponin: around 30% of patients may have an elevated troponin - Indicating possible myopericarditis  
- #ECG changes
    - Widespread (as opposed to localised in case of MI) ST elevation with concave upwards + PR segment depression- This is due to epicardium involvement. 
    - 'saddle-shaped' ST elevation
    - PR depression: most specific ECG marker for pericarditis
## ECG Images
- ![[pericarditis.png]]
- ![[ecg- segments and intervals.jpg]]
- ![[pericarditis- widespread ST elevation & PR depression.png]]
- ![[pericarditis- widespread st elevation without reciprocal changes, marked PR depression.png]]
# Management 
...
- 2nd line: Steroids
- Restrict strenuous physical activity till symptoms+ inflammatory markers settle
