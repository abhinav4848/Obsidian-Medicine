...
FeNO reflects the level of nitric oxide produced by airway epithelial cells in response to eosinophilic inflammation, a hallmark of [[asthma- diagnosis#First line investigation]]. It is measured non-invasively by having the patient exhale steadily into a handheld device, which analyses nitric oxide concentration in parts per billion (ppb).  
