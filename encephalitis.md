...
# Treatment
As over 95% of encephalitis cases are caused by herpes simplex virus (HSV), IV acyclovir (works against HSV) should be started in all patients urgently.

### Autoimmune encephalitis
is typically the result of a paraneoplastic syndrome (usually secondary to [[cancer- lung|Small cell carcinoma of Lung]] or ovarian teratoma). There should be evidence of malignancy in question for this.
