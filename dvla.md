...
urls:
  ...
  - "[Google Sheets summary](https://docs.google.com/spreadsheets/d/18WHVuO5aXoqRHLDKSRBBeZ6jEyKJWUxNcIJQIbGaw5w/edit?usp=sharing)"
---
...
* 6 months if EEG **normal** & CT head **normal**
* 12 months if something found

**Established epilepsy / multiple unprovoked seizures**
* If no seizure for 12 months → qualifies for DL
* No seizure for 5 years → restore till 70 yrs

**Withdrawal of meds**
* No driving till 6 months from last meds

---
## Syncope
* Simple faint → No restriction
* Single episode + explained & treated → 4 weeks off
* Single episode + unexplained → 6 months off
* ≥2 episodes → 12 months off
...
- Hypertension
    ...
    - if Group 2 Entitlement then disqualified from driving if resting BP consistently >= 180/100
...
- implantable cardioverter-defibrillator (ICD)
    ...
    - if implanted prophylactically then no driving for 1 month. Having an ICD results in a permanent bar for Group 2 drivers
...
| Condition                                                                                                                                                                                             | DVLA                                                             |
| ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------- |
| Severe anxiety or depression with any of the following: significant memory problems, significant concentration problems, agitation, behavioural disturbance or suicidal thoughts<br>Severe disability | must **not** drive and must notify the DVLA                      |
| Acute psychotic disorder, Hypomania or mania, Schizophrenia                                                                                                                                           | must **not** drive during acute illness and must notify the DVLA |
