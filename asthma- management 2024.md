...
AIR & MART contain the same ICS/Formoterol combo. So the name is only to emphasize the use case of the inhaler. Only to relieve vs. Relieve + Maintain. The key innovation isn’t the drugs, it’s the strategy. 
