...
- QRISK 3 score
	...
	- If risk >10% & age =<84yo, start statins (patients over 85 are high risk of CVD cuz of age alone)
	- Difference between 2 & 3 is the added mental health component in QRISK 3

NICE highlight that QRISK3 may still underestimate CVD risk in: 
- people treated for HIV
- people with serious mental illness
- people taking medicines that cause dyslipidaemia (e.g. antipsychotics, long-term corticosteroids, immunosuppressants)
- people with chronic inflammatory or autoimmune disorders (e.g. rheumatoid arthritis, SLE)
- Avoid QRISK3 in T1DM, CKD with eGFR <60 +- significant albuminuria, known familial hypercholestrolemia, established CVD (secondary prevention), as there are more specific disease based recommendations. 
# Aim of treatment
The aim of treatment is to achieve a greater than 40% reduction in baseline non-HDL cholesterol levels.  
  
If a > 40% reduction isn't achieved:  
  - Discuss adherence and timing of dose.  
  - Reinforce adherence to diet and lifestyle measures.  
  - Consider increasing the dose of atorvastatin if the person is judged to be at higher risk of CVD because of comorbidities or risk score, or using clinical judgement.  
...
- Increased risk of myositis when taken with other lipid lowering drugs, 
	...
	- danazol, 
- Avoid grapefruit if taking Atorvastatin, simvastatin, Lovastatin. 
