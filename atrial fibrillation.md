...
---
# Management
Do CHA2DS2-VASc + ORBIT Score -> give DOAC (if c/I e.g. valvular AF, then warfarin)
### Acute presentation ([NICE](https://www.nice.org.uk/guidance/ng196/chapter/Recommendations#management-for-people-presenting-acutely-with-atrial-fibrillation))
In people with new‑onset atrial fibrillation who are receiving no, or subtherapeutic, anticoagulation therapy:
- in the absence of contraindications (e.g. AF started within 48 hrs), offer heparin at initial presentation
- continue heparin until a full assessment has been made and appropriate antithrombotic therapy has been started, based on risk stratification (bleeding risk)
### Rate Control
BB or rate limiting CCB (e.g. Diltiazem).
...
### Rhythm Control
- Drugs such as flecainide may be used for chemical cardioversion. Do not use flecainide in the presence of HF, LV impairment, IHD, or prolonged QT interval. Cardiovert only in new AF <48 hrs or anticoagulation for > 3 weeks cuz risk of thromboembolism.
...
### Cardioversion
- If Onset <48 hrs ago: Following electrical cardioversion if AF is confirmed as being less than 48 hours duration then further anticoagulation is unnecessary.
