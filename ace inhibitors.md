...
#### Microalbuminuria
- ACEi are particularly helpful in protein-uric renal disease (e.g. diabetic retinopathy)
...
- Also see [[nsaid#NSAID & CKD linked|Triple whammy]]. 
- U&e must be checked before & after treatment is initiated (3 weeks) and after increasing dose.
	- When initiating ACE inhibitors, it is expected and acceptable to see a rise in creatinine & fall in eGFR. 
	- Deterioration of renal function greater than expected -> b/l renal stenosis.

|                                 | Creatinine rise                           | eGFR fall                      | Potassium rise | Notes                                                                                                                                       |
| ------------------------------- | ----------------------------------------- | ------------------------------ | -------------- | ------------------------------------------------------------------------------------------------------------------------------------------- |
| Normal                          | up to 50% from baseline (but <266 µmol/L) | a fall in eGFR <10% (but > 25) | <6 mmol/L      | Don't change dose, but repeat blood test in 1-2 weeks. Although any rise should prompt more monitoring & excluding other causes like NSAID. |
| [[chronic kidney disease\|CKD]] | <30% from baseline                        | <25% fall                      | <5.5 mmol/L    | Some sources say only 20% change in creat acceptable in CKD, but NICE says 30%                                                              |

Furosemide is useful as a anti-hypertensive in patients with CKD, particularly when the GFR falls to below 45 ml/min\*. It has the added benefit of lowering serum potassium. High doses are usually required. If the patient becomes at risk of [[sick day rule#Which drugs are included in sick day guidance? linked|dehydration]] (e.g. Gastroenteritis) then consideration should be given to temporarily stopping the drug  
  
\*the NKF K/DOQI guidelines suggest a lower cut-off of less than 30 ml/min
# Cautions and contraindications 
[NICE CKS- ACE inhibitors](https://cks.nice.org.uk/topics/heart-failure-chronic/prescribing-information/ace-inhibitors/)
...
- It's a [[sick day rule#Which drugs are included in sick day guidance? linked|SADMANS Drug]] drug so avoid in dehydration (e.g. diarrhoea). 
