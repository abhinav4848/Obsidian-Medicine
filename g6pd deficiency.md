...
- Heinz bodies on blood films ([[cell histology|degmacytes]]). Bite and blister cells may also be seen

Diagnosis is made by using a G6PD enzyme assay 
- levels should be checked around 3 months after an acute episode of haemolysis.
- RBCs with the most severely reduced G6PD activity will have haemolysed → reduced G6PD activity → not be measured in the assay → false negative results. 
